...
heatmap_short <- read_excel("micropollutant_biodegradation_redox/input_data/removal_efficiencies_manuscript_1.xlsx", col_types = c("text", "text", "text", "text",
...
heatmap_final <- heatmap_ordered %>%
      ...
      mutate(RemovalEfficiency = cut(Removal_Efficiency,breaks=c(-100, -90, -60, -30, 30, 60, 90, max(Removal_Efficiency, na.rm=T)),
...
data_short <- read_excel("micropollutant_biodegradation_redox/input_data/consumption_data_manuscript_1.xlsx", col_types = c("text", "text", "text", "text",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
...
### 1.2.9. Keeping only TOC
```{r keep electron acceptor, message=F, echo=T, eval=T, warning=T, include=T, cache=F}
data_DOC <- data_ordered %>% filter(Compound == "DOC")
```
...
**Figure 1**. Removal efficiency of each micropollutant for the different redox condition/community type combinations between the 1st and 2nd spike (reported values are the average of the duplicates).<br>
...
**Figure 2**. Removal efficiency of each micropollutant for the different redox condition/community type combinations 75 days after the 2nd spike (reported values are the average of the duplicates).<br>
...
**Figure S2**. Biodegradation curves of micropollutants removed during the 1st spike for each redox conditions and microbial community combination (reported values are the average of the duplicates).<br>
...
**Figure 3**. Biodegradation curves of micropollutants removed after both the 1st and the 2nd spike for each combination of redox condition and microbial community type (reported values are the average of the duplicates).<br>
...
ao <- ggplot(data = data_aerob_oxygen, mapping = aes(x = Time,
  ...
  scale_x_continuous(limits = c(0, 100), 
                     breaks = seq(0, 75, 25), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-1.63, 0.03), 
                     breaks = seq(-1.6, 0, 0.2), 
                     expand = c(0,0), 
...
ac <- ggplot(data = data_aerob_carbondiox, mapping = aes(x = Time,
  ...
  scale_x_continuous(limits = c(0, 100), 
                     breaks = seq(0, 75, 25), 
                     expand = c(0,0)) +
scale_y_continuous(limits = c(-0.01, 0.57), 
                   breaks = seq(0, 0.56, 0.07), 
                   expand = c(0,0), 
...
aa <- ggplot(data = data_aerob_ammonium, mapping = aes(x = Time,
  ...
  scale_x_continuous(limits = c(0, 100), 
                     breaks = seq(0, 75, 25), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-1.31, 0.03), 
                     breaks = seq(-1.28, 0, 0.16), 
                     expand = c(0,0), 
                     labels = label_number(accuracy = 0.01)) +
  theme_classic() +
  theme(axis.text = element_text(size = 7, colour = "black"),
...
an <- ggplot(data = data_aerob_nitrate, mapping = aes(x = Time, 
  ...
  scale_x_continuous(limits = c(0, 100), 
                     breaks = seq(0, 75, 25), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-0.02, 0.98), 
                     breaks = seq(0, 0.96, 0.12), 
                     expand = c(0,0), 
                     labels = label_number(accuracy = 0.01)) +
  theme_classic() +
  theme(axis.text = element_text(size = 7, colour = "black"),
...
nn <- ggplot(data = data_nitrate_nitrate, mapping = aes(x = Time, 
  ...
  scale_x_continuous(limits = c(0, 151), 
                     breaks = seq(0, 130, 30), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-2.04, 0.04), 
                     breaks = seq(-2, 0, 0.25), 
                     expand = c(0,0), 
                     labels = label_number(accuracy = 0.1)) +
  theme_classic() +
...
nc <- ggplot(data = data_nitrate_carbondiox, mapping = aes(x = Time, 
  ...
  scale_x_continuous(limits = c(0, 151), 
                     breaks = seq(0, 130, 30), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-0.008, 0.408), 
...
s <- ggplot(data = data_sulfate_sulfate, mapping = aes(x = Time, 
  ...
  scale_x_continuous(limits = c(0, 110), 
                     breaks = seq(0, 110, 30), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-0.897, 0.017), 
                     breaks = seq(-0.88, 0, 0.11), 
                     expand = c(0,0), 
                     labels = label_number(accuracy = 0.01)) +
  theme_classic() +
  theme(axis.text = element_text(size = 7, colour = "black"),
...
**Figure S3**. Cumulative consumption and production of different compounds per community type (reported values are the average of the duplicates) A) Consumption of oxygen and ammonium and production of carbon dioxide and nitrate under aerobic conditions; B) Consumption of nitrate and production of carbon dioxide under nitrate reducing conditions; C) Consumption of sulfate under sulfate reducing conditions.<br>

### 2.2.4. TOC
```{r overall activity, message=F, echo=T, eval=T, warning=T, include=T, cache=F, fig.width=4, fig.height=2}
...
**Figure S6**. DOC consumption by each microbial community under aerobic conditions (reported values are the average of the duplicates).<br>
