...
knitr::opts_chunk$set(echo = TRUE) # global option that prevents code, errors and messages, but not the results from appearing in the finished file

setwd("C:/Users/Rita/Documents/R/Article1") #set working directory
...
This documents comprises the figures and main conclusions of the results and discussion section of the article *Micropollutants degradation potential and microbial community dynamics of soil and activated sludge cultures under five different redox conditions*.
...
```{r warning=FALSE}
heatmap_short <- read_excel("C:/Users/Rita/Documents/R/Article1/input_data/Article1_heatmap.xlsx", col_types = c("text", "text", "text", "text",
...
```{r warning=FALSE}
data_short <- read_excel("C:/Users/Rita/Documents/R/Article1/input_data/Article1_graphs.xlsx", col_types = c("text", "text", "text", "text",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
                                                               "numeric", "numeric", "numeric",
...
## 1.3. Chloridazon and metabolites

# 2. Results and Discussion

## 2.1. Overview

### 2.1.1. Before VS After re-spiking
```{r}
# display.brewer.pal(n = 8, name = 'RdBu')
# brewer.pal(n = 8, name = "RdBu")
#dev.new(width = 8, height = 6, noRStudioGD = TRUE)

ggplot(data = heatmap_final, aes(x = RedoxCondition, y = Compound, fill = RemovalEfficiency)) +
  geom_tile(colour = "white", size = 0.2) +
  facet_nested(Respike ~ Inoculum) +
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_Overview.pdf", width = 8, height = 6)
```

### 2.1.2. Before re-spiking
```{r}
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_1.pdf", width = 8, height = 4)
```

### 2.1.3. After re-spiking
```{r}
#display.brewer.pal(n = 11, name = 'RdBu')
#brewer.pal(n = 11, name = "RdBu")
#dev.new(width = 8, height = 4, noRStudioGD = TRUE)
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_2.pdf", width = 8, height = 4)
```
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_S1.pdf", width = 6, height = 8)
```
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_S2.pdf", width = 6, height = 8)
```
...
#### 2.2.3.4. Methanogenic
```{r}
m <- ggplot(data = data_methanogen_methane, mapping = aes(x = Time, 
                                                          y = Concentration, 
                                                          colour = Inoculum, 
                                                          fill = Inoculum, 
                                                          shape = Inoculum, 
  ...
  scale_linetype_manual(breaks = breaksinoculum_1, 
                        values = c(1,1,1,1)) +
  scale_x_continuous(limits = c(0, 131), 
                     breaks = seq(0, 131, 15), 
                     expand = c(0,0)) +
  scale_y_continuous(limits = c(-0.0125, 0.5125), 
                     breaks = seq(0, 0.5, 0.0625), 
                     expand = c(0,0), 
                     labels = label_number(accuracy = 0.1)) +
  theme_classic() +
  theme(axis.text = element_text(size = 7, colour = "black"),
...
ggsave("C:/Users/Rita/Documents/R/Article1/figures/Figure1_3.pdf", width = 8, height = 4)
```