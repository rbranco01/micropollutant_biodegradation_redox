...
physeq = qza_to_phyloseq(features = "input_data/physeq_manuscript_1.qza",
                        tree = "input_data/tree_manuscript_1.qza",
                        taxonomy = "input_data/taxonomy_manuscript_1.qza",
                        metadata = "input_data/metadata_manuscript_1.txt")
```
...
```{r alpha diversity inocula, message=F, echo=T, eval=T, warning=T, include=T, cache=T, fig.width=4, fig.height=3}
...
alpha_data_inoculum <- alpha_data %>% filter(str_detect(redox_type, 'inoculum'))

# plot inocula alpha populations bars
alpha_data_inoculum %>% 
  ...
  labs(y = "ASV richness (Chao1)", x= "Community type") +
  theme_classic() +
  theme(axis.text = element_text(size = 7, colour = "black"),
...
**Figure 4A**. Microbial community diversity across inocula and inocula-derived communities under different redox conditions. A) Alpha diversity expressed as estimated ASV richness (Chao1).<br>
...
**Figure S6A**. Microbial community diversity across inocula and inocula-derived communities under different redox conditions. A) Alpha diversity expressed as estimated ASV richness (Chao1). Bars represent mean values of technical extraction duplicates.<br>
...
**Figure S6B and S6C**. B) Jaccard and C) unweighted UniFrac distances between each inoculum and respective derived microbial communities under different redox conditions, this difference between B) and C) represents the phylogenetic clustering of the observed ASVs.<br>
...
# chemical data
chem_data = readxl::read_xlsx("input_data/chemical_data_manuscript_1.xlsx")
